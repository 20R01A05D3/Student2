...
public class StudentValidation {
	...
	StudentRegister theStudents[] = new StudentRegister[50];

	public static int count = 0;

	// Method 1
	// To add books
	public void addStudent(StudentRegister s)
	{
	...
	// Method 4
	// To remove the book
	public void checkOutBook(Books2 book)
	{
	...
	// Method 5
	// To add the book
	public void checkInBook(Books2 book)
	{
		int studentIndex = this.isStudent();
		if (studentIndex != -1) {
			...
			StudentRegister s = theStudents[studentIndex];
